        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Laporan Laptop</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Data Laporan Laptop</li>
                        </ol>
                        <div class="tab-content">
                        <!-- Tanggal Pinjam -->
                        <div class="tab-pane active" id="tgl">
                            <section id="new">
                                <form action="aksi_laporan.php?aksi=tgl" method="POST" target="_blank">
